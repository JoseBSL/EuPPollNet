...
data <- read_csv("Data/Raw_data/42_Knight/Interaction_data.csv")
...
flower_count <- read_csv("Data/Raw_data/42_Knight/Flower_count.csv")
...
#Save data
saveRDS(Knight, file="Data/Clean_data/42_Knight.rds")
