...
#Try to fix days
data = data %>% 
  mutate(Day = as.Date(Day, origin = "2018-01-01")) %>% 
...
Authorship <- data.frame(
  Coauthor_name = c("Cian White", "Jane Stout"),
  Orcid = c(NA, "0000-0002-2027-0863"),
...
#Save data
saveRDS(White, file="Data/Clean_data/37_White.rds")
