...
data <- read_csv("Data/1_Raw_data/3_Michez/interaction_data.csv")
...
Authorship <- data.frame(
  Coauthor_name = c("Denis Michez", "William Fiordaliso", "Sara Reverté"),
...
#Save data
saveRDS(Michez, file="Data/2_Processed_data/3_Michez.rds")
