...
data = read_csv("Data/Raw_data/16_17_Manincor/interaction_data1_manincor.csv", col_names = T)
...
flower_count = read_csv("Data/Raw_data/16_17_Manincor/flower_count_data1_manincor.csv", col_names = T)
