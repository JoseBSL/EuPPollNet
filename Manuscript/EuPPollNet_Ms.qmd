...
Although Europe contains a much larger number of flowering plants than pollinator species (~4 to 1 ratio), the observed number of pollinator species almost doubled the one of observed plant species. This seems a common feature of phytocentric plant-pollinator networks, which tend to overlook rare plant species and capture a higher proportion of pollinator species [REF].
...
The number of pollinator species almost doubled the number of plant species within the database. This is a common aspect in phytocentric networks [@jordano2016], where an observer records the different pollinators that land on the reproductive structures of plants, resulting in a higher number of pollinator species per plant. 

Link with connectance now?
