...
Bee diversity peaked in the Mediterranean area as found in previous large scale comparisons [REF] and beetles were particularly relevant in this region

, while non-bee insects such as syrphids were particularly relevant in colder 
non-bee insect pollinators were particularly relevant 



Hymenoptera and Diptera had a similar number of species, the majority of interactions were conducted by bees. 


Bees conducted the majority of interactions within the database which is in agreement with previous large scale studies conducted in Europe [REF]. 




and for the majority of Angiosperm species worldwide [@ollerton2017]. The proportion of the major pollinator orders within the database 



Despite Hymenoptera and Diptera species have a similar number of species within the database, bees conducted most of the interactions as found in previous large scale studies [@Lanuza2023].
...
Despite a similar number of Hymenoptera and Diptera species, most of the interactions were done by Hymenoptera species (i.e., mainly bees). Notably, 

Ollerton
Contextualise European diversity of plant and pollinator species with global biodiveristy


Network metric paragraph?
This higher number of pollinator species compared to plants seems to be a common feature of phytocentric sampled plant-pollinator networks [@jordano2016].
...
Minor things to say
-Presence of honey bees in context with previous studies
Maybe cite Proc B and myself?
