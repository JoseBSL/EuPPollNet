...
Things to do:
-Habitat Figure: Patterns of boreal are weird --> Comment in results or discussion
-Figure 2 Bombus por encima de Apis, explain that Apis is not included
-Intro: Somewhere, bur maybe later, we should mention what we add. 1) Way more networks than those on Mangal or Webof life (which you should cite). 2) curated metadata and harmonization, 3) Community level data and not only isolated interactions as in GloBI.
-Network properties / significance issue
