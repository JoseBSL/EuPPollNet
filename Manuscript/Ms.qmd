...
Define study area//Data structure? TABLE? Describe cols?
...
```{r echo=FALSE, message=FALSE, cache=FALSE, warning=FALSE, out.width="95%", fig.width=10, fig.height=10, fig.cap= "\\textbf{Figure 2}. Phylogenetic representation of the bee genera in the SafeNet database within the context of all European bee genera. The number of interactions recorded in the database per genus is depicted with circles of proportional size corresponding to the number of interactions. The coverage of species per genus is depicted with orange and light blue bars, representing the percentage of species included and not included in the database, respectively, out of the total number of species per genus at the European level. Grey bars indicate the total number of species per genus at the European level."}
