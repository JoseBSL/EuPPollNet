...
Here, we present the SafeNet database, an acronym derived from the European project Safeguard and plant-pollinator networks, which contains harmonize interaction data of plants and pollinators at European level.
