...
```{r echo=FALSE, message=FALSE, cache=FALSE, warning=FALSE, out.width="100%", fig.cap= "\\textbf{Figure S2}. Barplot indicating the number of sampling sites by habitat and bioclimatic region within the database.", fig.width=8, fig.height=8}
