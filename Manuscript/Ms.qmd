...
safenet_database = readRDS("../Data/3_Final_data/safenet_database.rds")
...
my_tibble = d %>%
  mutate(Description = case_when(
    ...
    Variable == "Latitude-Longitude" ~ "Coordinates of the observed interaction in decimal degrees (two columns)",
