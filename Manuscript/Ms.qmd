...
The interaction between plants and pollinators is one of the most well-documented mutualisms on Earth. Plant-pollinator interactions involve a great diversity of species, largely attributed to their coevolutive history [@ollerton2017], and are critically important for terrestrial biodiversity [REF?] and human economy [REF?]. The synergistic effect of climate change with other global change pressures are threatening worldwide biodiversity [@sala2000; @bellard2014], including plant and pollinator species as well as their interactions [@gonzalez2013; @settele2016]. Documenting plant and pollinator diversity is the first step to conserve their biodiversity [REF]. Europe is one of the continents with more information about their plant and pollinator species as indicated by the recently available checklists of plants [REF] and pollinators [REF]. However, despite the increasing number of studies documenting their interactions at European level, we lack robust datasets of their ecological interactions at European level, which has crucial implications to understand the different biological phenomena involved around these twp trophic levels.


2nd paragraph

Plant-pollinator databases? 

Mangal/Web of life/the new one that has a bit of everything... 
